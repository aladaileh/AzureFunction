...
def KHNPAvialability(timer3: func.TimerRequest, outputblob2: func.Out[str]):
    ...
    try:
        ...
        KHNPAvailability['SubSubTybe']=np.nan
        KHNPAvailability['Unit']='MW'
        KHNPAvailability['HubType']='Generation Unit'
        KHNPAvailability['FreeText']=np.nan
        column_names=['ValueDate','AsOfDate','Location','Commodity','Period','Source','Senario','Timestamp','Type','Value','SubType','SubSubTybe','Unit','HubType','FreeText']
